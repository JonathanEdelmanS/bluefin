...
# ╔═╡ d7a01c5b-a121-45ee-b945-404efd778e26
p[1]

# ╔═╡ c2e3f6ae-e42e-4d27-89d1-a4bf55847bd2
ρ[1]

# ╔═╡ 84381196-a008-458f-bb1d-d2f5f4fc53a0
T[1]

# ╔═╡ 723af105-4907-4768-9474-c7b5891007d4
p[2]/(ρ[2] * T[2])

# ╔═╡ 88e77581-2162-4fc1-945a-7a847be05023
r[2:end]-r[1:end-1]
...
begin
	...
	, comment="#", DataFrame)
	ρ = onetime.density_gas[2:10]
	p = onetime.pgas[2:10]
	T = onetime.temperature[2:10] .+273.15
	pρt = p./(ρ.*T)
	r = onetime.x[2:10]
