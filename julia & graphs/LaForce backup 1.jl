...
# ╔═╡ 39895d40-5e7b-41f7-ae49-373a63f75803
"Flux = 0.0691kg/s"
...
# ╔═╡ fb254cff-b050-4c1e-aff3-80267bfe7c67
timesSW

# ╔═╡ 6022a4f7-d7be-469d-afc4-20e677e17abf
 propheatmapSW("pwater", length(timesSW))
...
heatmap(radii[3:end], timesIG[2:end] , propheatmapIdeal("disp_r", 186)[3:end, 1:end]', yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "Disp, Ideal Gas, pinf = 6.798 MPa",  left_margin = 13mm, right_margin = 10mm)

# ╔═╡ 20057c28-2a7d-4c6c-8f7d-46afd49825c7
heatmap(radii[3:end], timesIG[2:end] , propheatmapIdeal("sgas", 186)[3:end, 1:end]', yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "sgas, Ideal Gas, pinf = 6.798 MPa",  left_margin = 13mm, right_margin = 10mm)

# ╔═╡ b09a6319-6f24-406b-8611-c34c17310b54
heatmap(radii[3:end], timesIG[2:end] , propheatmapIdeal("pwater", 186)[3:end, 1:end]'./1e6, yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "p (MPa), Ideal Gas, pinf = 6.798MPa",  left_margin = 13mm, right_margin = 10mm)

# ╔═╡ 904628ac-935e-429d-a91c-d0632f7268b9
heatmap(radii[3:end], timesIG[2:end] , propheatmapIdeal("temp", 186)[3:end, 1:end]', yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "Temp(K), Ideal Gas, pinf = 6.798 MPa",  left_margin = 13mm, right_margin = 10mm)

# ╔═╡ f05f1416-80aa-4ee9-8daa-b3a9c97499de
heatmap(radii[3:end], timesSW[2:178] , propheatmapSW("disp_r", 177)[3:end, 1:end]', yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "Disp, Span-Wagner, pinf = 6.798 MPa",  left_margin = 13mm, right_margin = 10mm)

# ╔═╡ b323aa45-ef1e-4847-963e-2672a252e5b3
heatmap(radii[3:end], timesSW[2:end] , propheatmapSW("sgas", 177)[3:end, 1:end]', yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "sgas, Span-Wagner, pinf = 6.798 MPa",  left_margin = 13mm, right_margin = 10mm)

# ╔═╡ 898dbeb6-6a3d-4e88-bd2e-eb09b147f66b
heatmap(radii[3:end], timesSW[2:end] , propheatmapSW("pwater", length(timesSW)-1)[3:end, 1:end]'./1e6, yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "p(MPa), Span-Wagner, pinf = 6.798 MPa",  left_margin = 13mm, right_margin = 10mm)

# ╔═╡ e894d08e-f5aa-4e7a-8493-2c51b4c13d07
heatmap(radii[3:end], timesSW[2:end] , propheatmapSW("temp", length(timesSW))[3:end, 2:end]', yscale=:log10, xscale=:log10, ylabel = "t (s)", xlabel = "r (m)", title= "Temp(K), Span-Wagner, pinf = 6.798 MPa",  left_margin = 13mm, right_margin = 10mm)
...
manifest_format = "2.0"
project_hash = "ddd55aa25e0871423319a16e1a997a81ff29c50a"
