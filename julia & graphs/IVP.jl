...
# ╔═╡ c500446e-81ee-11ef-2066-5113c2f17411
begin
...
# ╔═╡ afd31314-fd46-44b9-8fdf-c480d28e930a
begin
	X = 1 #Meters
	xspan = (0.0, X)
	T = 273.15 + 20 #Kelvin
	...
	u0 = 100000#.5 * sqrt(R*T)
	ϵ0 = -.5*u0^2
	ρ0 = 1#1.98 #kg·m-3
	s0 = [u0, ϵ0, ρ0]

	pipeprob = ODEProblem(pipe!,s0,xspan)
end

# ╔═╡ 31901483-12b3-4614-82ef-26f6cccc139c
1.98 / .45 * (3 - R * T / 3)

# ╔═╡ c40ee0cb-99c4-4d4b-a787-1d03adeb6dbb
1.98 / .5 * (3 - R * T / 3) * u0/X

# ╔═╡ 072aef50-53cf-4cdc-ac27-99477ec0f987
pipesol = solve(pipeprob, Tsit5())

# ╔═╡ 9184353f-b903-475b-ae16-470ad97382ea
begin
	x = 984.7
	pipesol(1)
end

# ╔═╡ 6ad03c66-835f-4b06-a5b8-a1faef3b191d
plot(pipesol)

# ╔═╡ aa3daaa3-fc38-4df1-83a8-bda99e48f8b1
u0 + ϵ0*x

# ╔═╡ 192c2294-b9d8-44e0-8b97-098b77209dcb
ϵ0

# ╔═╡ e813cb3e-bb79-4a6d-8222-91a489489c33
 ρ0*u0/(u0 + ϵ0*x)

# ╔═╡ 4e849a59-6f17-400a-8b51-eaa8835897a4
pipesol[end:end]
...
manifest_format = "2.0"
project_hash = "6e851d5408b2c2cfbfb2bbb6c355ecb5df7e8a6c"
