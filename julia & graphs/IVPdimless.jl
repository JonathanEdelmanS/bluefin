...
# ╔═╡ 42032ec6-8202-11ef-3222-0ba8d3cbab05
begin
	...
	M = .5
	W = .5
	r = ((1 - W)*M + 1/M + √(((1 - W)M + 1/M)^2 - 4))/2

	function dimpipe!(dv, v, p, x)
	    dv[1] =  (1/(W*v[1]))*(1 - (r + 1/r)*v[1] + (v[1])^2)
	end

end

# ╔═╡ 4e845bfe-5021-415b-8576-5a70e997a644
dimpipeprob = ODEProblem(dimpipe!,[1.6],xspan)


# ╔═╡ 78666f1f-9185-4e3c-b8c5-8a893eaeaf0e
 sol = solve(dimpipeprob, Tsit5())

# ╔═╡ 09611f46-b8d2-4a08-99c6-6b3c1facee21
plot(sol)

# ╔═╡ df1f1935-dbdb-4517-9b44-78f62c47af09
begin
	dimpipeprobs = [ODEProblem(dimpipe!,[inits],xspan) for inits in 1.6403:.00001:1.64038]
	sols = [solve(el, Tsit5()) for el in dimpipeprobs]
end

# ╔═╡ 24edec53-c2d0-470d-bcb9-80893480b554
begin
	plot()
	for el in sols
		plot!(el)
...
# ╔═╡ d54bb76f-a801-445f-a26b-720278e4ece2
plot(xs,sols[1])

# ╔═╡ 83e2084c-21cd-4f50-9d94-6b33678be45f
xs = sols[1](collect(1:20))][:]
...
manifest_format = "2.0"
project_hash = "8d5ea01f2d6dda571db69051a8efd26bfd004264"
