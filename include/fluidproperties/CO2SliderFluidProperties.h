 ...
 */
class CO2SliderFluidProperties : public HelmholtzFluidProperties
{
public:
  static InputParameters validParams();

  CO2SliderFluidProperties(const InputParameters & parameters);
  virtual ~CO2SliderFluidProperties();
