...
[VectorPostprocessors]
  [horizontal_y0]
    ...
    start_point = '0.1 0.0 0'
    end_point = '100.0 0.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y1]
    type = LineValueSampler
    start_point = '0.1 1.0 0'
    end_point = '100.0 1.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y2]
    type = LineValueSampler
    start_point = '0.1 2.0 0'
    end_point = '100.0 2.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y3]
    type = LineValueSampler
    start_point = '0.1 3.0 0'
    end_point = '100.0 3.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y4]
    type = LineValueSampler
    start_point = '0.1 4.0 0'
    end_point = '100.0 4.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y5]
    type = LineValueSampler
    start_point = '0.1 5.0 0'
    end_point = '100.0 5.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y6]
    type = LineValueSampler
    start_point = '0.1 6.0 0'
    end_point = '100.0 6.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y7]
    type = LineValueSampler
    start_point = '0.1 7.0 0'
    end_point = '100.0 7.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y8]
    type = LineValueSampler
    start_point = '0.1 8.0 0'
    end_point = '100.0 8.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y9]
    type = LineValueSampler
    start_point = '0.1 9.0 0'
    end_point = '100.0 9.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y10]
    type = LineValueSampler
    start_point = '0.1 10.0 0'
    end_point = '100.0 10.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
  ...
  [horizontal_y11]
    type = LineValueSampler
    start_point = '0.1 11.0 0'
    end_point = '100.0 11.0 0'
    num_points = 100
    variable = 'pwater temp sgas disp_r stress_rr stress_tt pgas'
    sort_by = x
    outputs = csv
