...
# ╔═╡ ab951d0a-1d46-4fcf-8995-34c8ec59b06d
...
# ╔═╡ bd43eae9-ef14-4c1b-8911-ba89e27373fa
#@bind t Clock()
...
velocities = read_values(exo, Exodus.ElementVariable, t, 0, "v")

# ╔═╡ 29a2c92e-76bf-4141-b720-cbcca9240c88
uvel = read_values(exo, Exodus.ElementVariable, t, 0, "u")
...
begin
	...
	ρplot= Plots.heatmap(xaxis, yaxis, DensityM', rightmargin=5Plots.mm,  title = "Density")#, clim=(-.015, .015))
...
manifest_format = "2.0"
project_hash = "b8b9b2150b90da9694ec65b273d6a36e855c6b61"
